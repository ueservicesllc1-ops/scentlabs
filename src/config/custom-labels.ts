...
export const STANDARD_LABEL_MATERIALS: LabelMaterial[] = [
  {
    id: "mat_black",
    name: "Matte Black Vinyl (Negro Mate)",
  ...
  {
    id: "gloss_black",
    name: "Glossy Black Vinyl (Negro Brillo)",
    description: "Fondo negro impermeable con reflejo brillante deslumbrante.",
    active: true,
    materialCostPerSqIn: 0.00250,
    productionCost: 0.03,
    additionalCost: 0.0,
    hexColorPreview: "#09090B",
    finishType: "glossy_black",
    priceMultiplier: 1.00,
  },
  {
    id: "mat_white",
    name: "Matte White Vinyl (Blanco Mate)",
  ...
  {
    id: "gloss_white",
    name: "Glossy White Vinyl (Blanco Brillo)",
    description: "Fondo blanco impermeable con acabado brillante esmaltado de lujo.",
    active: true,
    materialCostPerSqIn: 0.00250,
    productionCost: 0.03,
    additionalCost: 0.0,
    hexColorPreview: "#FAFAFA",
    finishType: "glossy_white",
    priceMultiplier: 1.00,
  },
  {
    id: "mat_gold",
