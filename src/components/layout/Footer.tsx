  ...
  return (
    <footer style={{ background: "#0E1A14", color: "rgba(255,255,255,0.6)", fontFamily: "var(--font-body)" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 40px 32px", display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40 }}>
        ...
        {/* Brand */}
        <div>
          <span style={{ fontSize: 13, fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color: "white", display: "block", marginBottom: 16 }}>
            SCENTLAB
          </span>
          ...
          <p style={{ fontSize: 11, color: "rgba(255,255,255,0.25)", margin: 0 }}>
            © {new Date().getFullYear()} SCENTLAB Wholesale. All rights reserved.
          </p>
        </div>
